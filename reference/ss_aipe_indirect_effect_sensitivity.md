...
- filename:
  ...
  (the sample indirect effect \\\hat a \hat b\\, the two confidence
  limits, the interval width, and two indicators of whether the interval
  missed `true_a * true_b` below or above): nothing is written when
