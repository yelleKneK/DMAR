...
A central *F* (`ncp = 0`) is the special case. The function was
`moments_ncf()` in earlier builds of DMAR.
...
the noncentral *F* confidence limits used in effect size intervals;
