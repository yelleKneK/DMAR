...
`noncentrality`, and `actual_power`.
...
ss_power_mixed_anova(a = 2, b = 4, effect = "between", f = 0.25,
                    rho = 0.5, desired_power = 0.80)
#>  term                  value
#>  necessary_n_per_group 80   
#>  total_N               160  
#>  effect_df             1    
#>  error_df              158  
#>  noncentrality         8    
...
ss_power_mixed_anova(a = 2, b = 4, effect = "within", f = 0.25,
                    rho = 0.5, desired_power = 0.80)
#>  term                  value
...
ss_power_mixed_anova(a = 2, b = 4, effect = "interaction", f = 0.25,
                    rho = 0.5, desired_power = 0.80)
#>  term                  value
#>  necessary_n_per_group 12   
#>  total_N               24   
...
ss_power_mixed_anova(a = 2, b = 4, effect = "interaction",
