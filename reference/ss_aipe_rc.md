...
estimation perspective for an unstandardized regression coefficient of
...
This function calls upon `ss_aipe_reg_coef` in DMAR but has a different
naming scheme. See `ss_aipe_reg_coef` for more details.
