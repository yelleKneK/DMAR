...
#' The confidence interval for the noncentral \emph{F} parameter can be obtained from the function \code{\link{ci_nc_F}}, which is used within this function.
#'
#' @return
