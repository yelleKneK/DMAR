...
#'
#' @seealso
#' \code{\link{ci_sc}}, \code{\link{ci_nc_t}}, \code{\link{ss_aipe_c}}
#'
#' @examples
...
ss_aipe_sc <- function(psi_standardized, c_weights, width,
    ...
    # (possibly asymmetric). The two cannot be mixed, matching ci_nc_t.
    ...
    if (is.null(assurance)) {
        ...
        lambda_limits_0 <- ci_nc_t(ncp = lambda_0, df = n * J - J,
                                            conf_level = NULL,
        ...
        while (Diff_width_Full > 0) {
            ...
            lambda_limits <- ci_nc_t(ncp = lambda, df = n * J - J,
                                              conf_level = NULL,
                                              alpha_lower = alpha_lower,
                                              alpha_upper = alpha_upper)
