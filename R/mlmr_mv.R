...
#'   The examples ask for the Wald and bootstrap intervals so the help
#'   page stays quick; a reported analysis leaves \code{ci_method} at
#'   its default.
...
#'   integer for reproducible bootstraps. When set, the seed applies
#'   for the duration of the call and the caller's generator state is
#'   restored on exit.
